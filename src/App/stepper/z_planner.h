...
class Planner {
  ...
  public:
    ...
    __INLINE static uint8_t movesplanned()
	{
		...
		return BLOCK_MOD(tmp - block_buffer_tail);
	}

    // Number of nonbusy moves currently in the planner
    __INLINE static uint8_t nonbusy_movesplanned()
	{
		uint8_t tmp = block_buffer_head;
		return BLOCK_MOD(tmp - block_buffer_nonbusy);
	}

    // Remove all blocks from the buffer
    __INLINE static void clear_block_buffer()
	{
    ...
    __INLINE static uint8_t moves_free()
	{
  ...
  public:
     ...
     */
    __INLINE static bool has_blocks_queued()
	{
		uint8_t tmp = block_buffer_head;
