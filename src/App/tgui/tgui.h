...
#define	FNAME_BKGR_FILES			(char*)"scr/scr_files.cimg"
#define	FNAME_BKGR_FILESLIST		(char*)"scr/scr_files_list.cimg"
#define	FNAME_BKGR_EMPTY			(char*)"scr/scr_empty.cimg"
#define	FNAME_BKGR_NUMENTER			(char*)"scr/scr_numenter.cimg"
#define	FNAME_BKGR_FILEVIEW			(char*)"scr/scr_fileview.cimg"
#define	FNAME_BKGR_PRINT			(char*)"scr/scr_print.cimg"
#define	FNAME_BKGR_CLOCKSET			(char*)"scr/scr_clockset.cimg"
#define	FNAME_BKGR_UVTEST			(char*)"scr/scr_uvtest.cimg"

#define	FNAME_BTN_MOVEZ_UP_EN		(char*)"btn/btn_movez_up_en.cimg"
#define	FNAME_BTN_MOVEZ_UP_PRESS	(char*)"btn/btn_movez_up_press.cimg"
#define	FNAME_BTN_MOVEZ_DN_EN		(char*)"btn/btn_movez_down_en.cimg"
#define	FNAME_BTN_MOVEZ_DN_PRESS	(char*)"btn/btn_movez_down_press.cimg"
#define	FNAME_BTN_MOVEZ_HOMERDY_EN	(char*)"btn/btn_movez_home_ready.cimg"
#define	FNAME_BTN_MOVEZ_HOMENRDY_EN	(char*)"btn/btn_movez_home_noready.cimg"

#define	FNAME_BTN_FILES_UP_DIS		(char*)"btn/btn_files_up_dis.cimg"
#define	FNAME_BTN_FILES_UP_EN		(char*)"btn/btn_files_up_en.cimg"
#define	FNAME_BTN_FILES_UP_PRESS	(char*)"btn/btn_files_up_press.cimg"
#define	FNAME_BTN_FILES_DN_DIS		(char*)"btn/btn_files_down_dis.cimg"
#define	FNAME_BTN_FILES_DN_EN		(char*)"btn/btn_files_down_en.cimg"
#define	FNAME_BTN_FILES_DN_PRESS	(char*)"btn/btn_files_down_press.cimg"
#define	FNAME_BTN_FILES_PREV_EN		(char*)"btn/btn_files_prev_en.cimg"
#define	FNAME_BTN_FILES_PREV_DIS	(char*)"btn/btn_files_prev_dis.cimg"
#define	FNAME_BTN_FILES_PREV_PRESS	(char*)"btn/btn_files_prev_press.cimg"
#define	FNAME_BTN_FILES_LIST_EN		(char*)"btn/btn_files_list_en.cimg"
#define	FNAME_BTN_FILES_LIST_DIS	(char*)"btn/btn_files_list_dis.cimg"
#define	FNAME_BTN_FILES_LIST_PRESS	(char*)"btn/btn_files_list_press.cimg"
#define	FNAME_BTN_FILES_ICONS_EN	(char*)"btn/btn_files_icons_en.cimg"
#define	FNAME_BTN_FILES_ICONS_DIS	(char*)"btn/btn_files_icons_dis.cimg"
#define	FNAME_BTN_FILES_ICONS_PRESS	(char*)"btn/btn_files_icons_press.cimg"
...
#define	FNAME_BTN_SETTINGS_ITEM1_EN		(char*)"btn/btn_settings_item1_en.cimg"
#define	FNAME_BTN_SETTINGS_ITEM1_PRESS	(char*)"btn/btn_settings_item1_press.cimg"

#define	FNAME_BTN_NUMENTER_AC_EN		(char*)"btn/btn_numenter_ac_en.cimg"
#define	FNAME_BTN_NUMENTER_AC_PRESS		(char*)"btn/btn_numenter_ac_press.cimg"
#define	FNAME_BTN_NUMENTER_DEL_EN		(char*)"btn/btn_numenter_del_en.cimg"
#define	FNAME_BTN_NUMENTER_DEL_PRESS	(char*)"btn/btn_numenter_del_press.cimg"
#define	FNAME_BTN_NUMENTER_DIG_EN		(char*)"btn/btn_numenter_dig_en.cimg"
#define	FNAME_BTN_NUMENTER_DIG_PRESS	(char*)"btn/btn_numenter_dig_press.cimg"

#define	FNAME_BTN_FILEVIEW_DEL_EN		(char*)"btn/btn_fileview_delete_en.cimg"
#define	FNAME_BTN_FILEVIEW_DEL_PRESS	(char*)"btn/btn_fileview_delete_press.cimg"
#define	FNAME_BTN_FILEVIEW_PRINT_EN		(char*)"btn/btn_fileview_print_en.cimg"
#define	FNAME_BTN_FILEVIEW_PRINT_PRESS	(char*)"btn/btn_fileview_print_press.cimg"

#define	FNAME_BTN_PRINT_PAUSE_EN		(char*)"btn/btn_print_pause_en.cimg"
#define	FNAME_BTN_PRINT_PAUSE_PRESS		(char*)"btn/btn_print_pause_press.cimg"
#define	FNAME_BTN_PRINT_PAUSE_ACT		(char*)"btn/btn_print_pause_act.cimg"
#define	FNAME_BTN_PRINT_SETT_EN			(char*)"btn/btn_print_sett_en.cimg"
#define	FNAME_BTN_PRINT_SETT_PRESS		(char*)"btn/btn_print_sett_press.cimg"
#define	FNAME_BTN_PRINT_STOP_EN			(char*)"btn/btn_print_stop_en.cimg"
#define	FNAME_BTN_PRINT_STOP_PRESS		(char*)"btn/btn_print_stop_press.cimg"
#define	FNAME_BTN_PRINT_LOCK_EN			(char*)"btn/btn_print_lock_en.cimg"
#define	FNAME_BTN_PRINT_LOCK_ACT		(char*)"btn/btn_print_lock_act.cimg"

#define	FNAME_BTN_CLOCKSET_OK_EN		(char*)"btn/btn_clockset_ok_en.cimg"
#define	FNAME_BTN_CLOCKSET_OK_PRESS		(char*)"btn/btn_clockset_ok_press.cimg"
#define	FNAME_BTN_CLOCKSET_UP_EN		(char*)"btn/btn_clockset_up_en.cimg"
#define	FNAME_BTN_CLOCKSET_UP_PRESS		(char*)"btn/btn_clockset_up_press.cimg"
#define	FNAME_BTN_CLOCKSET_DOWN_EN		(char*)"btn/btn_clockset_down_en.cimg"
#define	FNAME_BTN_CLOCKSET_DOWN_PRESS	(char*)"btn/btn_clockset_down_press.cimg"

#define	FNAME_BTN_UVTEST_LIGHT_EN		(char*)"btn/btn_uvtest_light_en.cimg"
#define	FNAME_BTN_UVTEST_LIGHT_PRESS	(char*)"btn/btn_uvtest_light_press.cimg"
#define	FNAME_BTN_UVTEST_DISP_EN		(char*)"btn/btn_uvtest_disp_en.cimg"
#define	FNAME_BTN_UVTEST_DISP_PRESS		(char*)"btn/btn_uvtest_disp_press.cimg"
#define	FNAME_BTN_UVTEST_IMAGE1_EN		(char*)"btn/btn_uvtest_img1_en.cimg"
#define	FNAME_BTN_UVTEST_IMAGE1_PRESS	(char*)"btn/btn_uvtest_img1_press.cimg"
#define	FNAME_BTN_UVTEST_IMAGE2_EN		(char*)"btn/btn_uvtest_img2_en.cimg"
#define	FNAME_BTN_UVTEST_IMAGE2_PRESS	(char*)"btn/btn_uvtest_img2_press.cimg"
#define	FNAME_BTN_UVTEST_IMAGE3_EN		(char*)"btn/btn_uvtest_img3_en.cimg"
#define	FNAME_BTN_UVTEST_IMAGE3_PRESS	(char*)"btn/btn_uvtest_img3_press.cimg"

#define	FNAME_BTN_PRNPARAMS_UP_EN		(char*)"btn/btn_prnparams_up_en.cimg"
#define	FNAME_BTN_PRNPARAMS_UP_PRESS	(char*)"btn/btn_prnparams_up_press.cimg"
#define	FNAME_BTN_PRNPARAMS_UP_DIS		(char*)"btn/btn_prnparams_up_dis.cimg"
#define	FNAME_BTN_PRNPARAMS_DOWN_EN		(char*)"btn/btn_prnparams_down_en.cimg"
#define	FNAME_BTN_PRNPARAMS_DOWN_PRESS	(char*)"btn/btn_prnparams_down_press.cimg"
#define	FNAME_BTN_PRNPARAMS_DOWN_DIS	(char*)"btn/btn_prnparams_down_dis.cimg"
#define	FNAME_BTN_PRNPARAMS_SAVE_EN		(char*)"btn/btn_prnparams_save_en.cimg"
#define	FNAME_BTN_PRNPARAMS_SAVE_PRESS	(char*)"btn/btn_prnparams_save_press.cimg"
#define	FNAME_BTN_PRNPARAMS_SAVE_DIS	(char*)"btn/btn_prnparams_save_dis.cimg"
#define	FNAME_BTN_PRNPARAMS_OK_EN		(char*)"btn/btn_prnparams_ok_en.cimg"
#define	FNAME_BTN_PRNPARAMS_OK_PRESS	(char*)"btn/btn_prnparams_ok_press.cimg"
...
#define	FNAME_ICN_FILES_CONFIG		(char*)"icn/icn_files_config.cimg"
...
#define		TG_SCR_SETTINGS_BUZZER_ID		23
#define		TG_SCR_SETTINGS_DISPDIS_ID		24
#define		TG_SCR_SETTINGS_SCREENSAVER_ID	25

#define		TG_BTN_CNT_SCREEN_SETTINGS		10
