...
void		_tgui_InfoScreenInfoPaint(void *tguiobj, void *param)
{
	...
	LCDUI_SetColor(LCDUI_RGB(0x00496C));
	sprintf(msg, "%u %s", cfgTimers.led_time / 3600, LANG_GetString(LSTR_SHORT_HOUR));
	LCDUI_DrawText(msg, LCDUI_TEXT_ALIGN_RIGHT, thisbtn->position.left + 5, ytop, thisbtn->position.right - 5, -1);
	// diaplay time
	ytop += fntheight + yinc;
	LCDUI_SetColor(LCDUI_RGB(0x000000));
	...
	LCDUI_SetColor(LCDUI_RGB(0x00496C));
	sprintf(msg, "%u %s", cfgTimers.disp_time / 3600, LANG_GetString(LSTR_SHORT_HOUR));
	LCDUI_DrawText(msg, LCDUI_TEXT_ALIGN_RIGHT, thisbtn->position.left + 5, ytop, thisbtn->position.right - 5, -1);
	// fan time
	ytop += fntheight + yinc;
	LCDUI_SetColor(LCDUI_RGB(0x000000));
	...
	LCDUI_SetColor(LCDUI_RGB(0x00496C));
	sprintf(msg, "%u %s", cfgTimers.fan_time / 3600, LANG_GetString(LSTR_SHORT_HOUR));
	LCDUI_DrawText(msg, LCDUI_TEXT_ALIGN_RIGHT, thisbtn->position.left + 5, ytop, thisbtn->position.right - 5, -1);
	// total print time
	ytop += fntheight + yinc;
	LCDUI_SetColor(LCDUI_RGB(0x000000));
	...
	LCDUI_SetColor(LCDUI_RGB(0x00496C));
	sprintf(msg, "%u %s", cfgTimers.total_print_time / 3600, LANG_GetString(LSTR_SHORT_HOUR));
	LCDUI_DrawText(msg, LCDUI_TEXT_ALIGN_RIGHT, thisbtn->position.left + 5, ytop, thisbtn->position.right - 5, -1);
	// URL 
	ytop += fntheight + yinc;
	LCDUI_SetColor(LCDUI_RGB(0x000000));
